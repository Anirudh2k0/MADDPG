...
class NewEnv(gym.Env):
    def __init__(self,df,corr_vals):
        ...
        self.action_space =  [spaces.Box(low=-1.0,high=1.0,dtype=np.float32,shape=(3,))]
    ...
    def step(self,actions):
        ...
        print(self.gammaRanges['zol'][0]*self.zoomdeps['Orientation_Loss'] <= self.correlations(actions,0,0.3,0)*10 <= self.gammaRanges['zol'][1]*self.zoomdeps['Orientation_Loss'])
